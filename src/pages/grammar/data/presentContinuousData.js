...
{
    title:'Affirmative, Negative and Question',
    description:' ',
table:[
    {first:"Affirmative", second:"Negative", third:'Question'},
    {first:"I *am* sleep*ing*", second:"I *am not* sleep*ing*", third:'*Am I* sleep*ing*?'},
    {first:"You *are* sleep*ing*", second:"You *are not* sleep*ing*", third:'*Are you* sleep*ing*?'},
    {first:"We *are* sleep*ing*.", second:"We *are not* sleep*ing*", third:'*Are we* sleep*ing*?'},
    {first:"They *are* sleep*ing*.", second:"They *are not* sleep*ing*", third:'*Are they* sleep*ing*?'},
    {first:"He *is* sleep*ing*.", second:"He *is not* sleep*ing*", third:'*Is he* sleep*ing*?'},
    {first:"She *is* sleep*ing*.", second:"She *is not* sleep*ing*", third:'*Is she* sleep*ing*?'},
    {first:"It *is* sleep*ing*.", second:"It *is not* sleep*ing*", third:'*Is it* sleep*ing*?  '},
  ]
},
